...
class DynamicAuthorizationPlugin(WechatyPlugin):
    ...
    """
    def __init__(self, options: Optional[WechatyPluginOptions] = None, config_file: str = '.wechaty/dynamic_authorise.json', conv_config_file: str = '.wechaty/conv2convs.xlsx'):
